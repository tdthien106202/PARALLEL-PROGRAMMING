#include "conv_gpu_op.h"
#include <math.h>
#include <iostream>

void Conv_GPU_OP::init() {
...
void Conv_GPU_OP::forward(const Matrix& bottom) {
...
void Conv_GPU_OP::backward(const Matrix& bottom, const Matrix& grad_top) {
}

void Conv_GPU_OP::update(Optimizer& opt) {
}

std::vector<float> Conv_GPU_OP::get_parameters() const {
...
void Conv_GPU_OP::set_parameters(const std::vector<float>& param) {
...
std::vector<float> Conv_GPU_OP::get_derivatives() const {
